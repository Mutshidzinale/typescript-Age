...
else  if (students[3].studAge>students[0].studAge&&students[3].studAge>students[1].studAge&&students[3].studAge>students[2].studAge&&students[2].studAge>students[4].studAge&&students[3].studAge>students[5].studAge&&students[3].studAge>students[7].studAge&&students[3].studAge>students[8].studAge&&students[3].studAge>students[9].studAge){
